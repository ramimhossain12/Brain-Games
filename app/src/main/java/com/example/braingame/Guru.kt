...
class Guru : FragmentActivity(), NumpadListener, ScoreListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = GuruArray(this, listQuestions)
    ...
    override fun onNumClick(input: Int) {
        try {
            val listView = findViewById<View>(R.id.listView) as ListView
            val adapter = listView.adapter as GuruArray
