...
class NoviceArray(context: Context?, questions: ArrayList<Question>) : ArrayAdapter<Question?>(context!!, 0, questions!! as List<Question?>) {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        txtquestion.text = ques!!.noviceLine
